(() => {
  ...
  const resolve_action = document.querySelector('#support-chat__actions > .support-chat__action')
  ...
  button.onclick = () => {
    ...
    check_rooms()
    rooms_checker = setInterval(check_rooms, 10000) // every 10s
