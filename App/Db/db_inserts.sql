...
VALUES (1, 'Hawaii Header', 'image/jpg', 'Sunset in Hawaii', '/images/hawaiiHeader.jpg', 1);

INSERT INTO `media` (`id`, `name`, `media_type`, `description`, `path`, `header`)
VALUES (2, 'War Plane', 'image/jpg', 'Image of a war plane', '/images/phAviation.jpg', 0);

INSERT INTO `media` (`id`, `name`, `media_type`, `description`, `path`, `header`)
VALUES (3, 'D.K Steak', 'image/jpg', 'T-Bone Steak', '/images/dkSteak.jpg', 0);

INSERT INTO `media` (`id`, `name`, `media_type`, `description`, `path`, `header`)
VALUES (4, 'Hawaii Resort', 'image/jpg', 'Volcano Resort', '/images/craterEdge.jpg', 0);

INSERT INTO `media` (`id`, `name`, `media_type`, `description`, `path`, `header`)
VALUES (5, 'Venice Hotel', 'image/jpg', 'image of a room of Hotel Continental Venice', '/images/hotelVenice.jpg', 0);

INSERT INTO `media` (`id`, `name`, `media_type`, `description`, `path`, `header`)
VALUES (6, 'Gondola', 'image/jpg', 'Gondola on the water in Venice', '/images/gondola.jpg', 0);

INSERT INTO `media` (`id`, `name`, `media_type`, `description`, `path`, `header`)
VALUES (7, 'Tower of Pisa', 'image/jpg', 'The Tower of Pisa in Italy', '/images/pisaTower.jpg', 0);

INSERT INTO `media` (`id`, `name`, `media_type`, `description`, `path`, `header`)
VALUES (8, 'Coliseum', 'image/jpg', 'Picture of the coliseum at night', '/images/coliseum.jpg', 0);
